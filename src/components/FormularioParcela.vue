    ...
    <div class="row">
      <div class="d-flex">    
        <form class="shadow m-3 p-5 w-75" @submit.prevent="salvarParcela">
          ...
          <input type="text" id="item.id_cliente_banco" class="form-control" v-model="parcela.tabela.nome_tabela">

          <label class="p-1 pt-3">Parcela</label>
          <input type="text" id="item.id_cliente_banco" class="form-control" v-model="parcela.parcela">

          <label class="p-1 pt-3">Juros Parcela</label>
          <input type="text" id="item.juros_parcela" class="form-control" v-model="parcela.juros_parcela">

          <label class="p-1 pt-3">Valor Juros Parcela</label>
          <input type="text" id="item.valor_juros_parcelado" class="form-control" v-model="parcela.valor_parcela">

          <label class="p-1 pt-3">Valor Total</label>
          <input type="text" id="cliente_banco.cliente" class="form-control" v-model="parcela.valor_total">

          <label class="p-1 pt-3">Comissão</label>
          <input type="text" id="item.valor_comissao" class="form-control" v-model="parcela.comissao">
