    ...
    <div class="row">
      <div class="d-flex">    
        <form class="shadow m-3 p-5 w-75" @submit.prevent="salvarSolicitacoes">
          ...
          <input  type="text" id="item.id_cliente_banco" class="form-control" v-model="solicitacao.juros_parcela">

          <label class="p-1 pt-3">Valor do Juros Parcelado</label>
          <input  type="text" id="item.id_cliente_banco" class="form-control" v-model="solicitacao.valor_juros_parcelado">

          <label class="p-1 pt-3">Comissão</label>
          <input  type="text" id="item.juros_parcela" class="form-control" v-model="solicitacao.comissao">

          <label class="p-1 pt-3">Valor da Comissão</label>
          <input  type="text" id="item.valor_juros_parcelado" class="form-control" v-model="solicitacao.valor_comissao">

          <label class="p-1 pt-3">Valor da Parcela</label>
          <input  type="text" id="cliente_banco.cliente" class="form-control" v-model="solicitacao.valor_parcela">

          <label class="p-1 pt-3">Numero Cartão</label>
          <input  type="text" id="item.valor_comissao" class="form-control" v-model="solicitacao.numero_cartao">

          <label class="p-1 pt-3">Valor Desejado</label>
          <input  type="text" id="item.valor_comissao" class="form-control" v-model="solicitacao.valor_desejado">

          <label class="p-1 pt-3">Total Emprestimo</label>
          <input  type="text" id="item.valor_comissao" class="form-control" v-model="solicitacao.total_emprestimo">
